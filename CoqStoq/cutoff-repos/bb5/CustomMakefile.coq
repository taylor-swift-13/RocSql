...
include CustomMakefile.coq.conf
...
# put in CustomMakefile.coq.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in CustomMakefile.coq.local
#
###############################################################################
...
#
# There rules can be extended in CustomMakefile.coq.local
...
VDFILE_FLAGS:=$(if _Custom_CoqProject,-f _Custom_CoqProject,) $(CMDLINE_COQLIBS) $(CMDLINE_VFILES)

$(VDFILE): _Custom_CoqProject $(VFILES)
	$(SHOW)'COQDEP VFILES'
...
# extension points and CustomMakefile.coq.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in CustomMakefile.coq.local or include CustomMakefile.coq.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in CustomMakefile.coq.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create CustomMakefile.coq.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include CustomMakefile.coq.local-late
